...
## 2025-04-18 - Required Field Indicators in Streamlit
**Learning:** Streamlit does not natively provide a way to visually mark input fields as "required". Users must fill out a form and submit it before encountering validation errors, which causes frustration.
**Action:** Always append an asterisk (*) to the label of required fields and include `help="Required field"` to provide an immediate visual cue and accessible tooltip before the user attempts submission.
