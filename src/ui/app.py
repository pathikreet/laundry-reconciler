...
def page_reconciliation(session_db):
    ...
    if mode == "📅 Single Date":
        run_date = st.date_input("Select Date to Reconcile *", value=date.today(), help="Required field")
        ...
        with col_start:
            start_date = st.date_input("Start Date *", value=date(2025, 11, 1), key="recon_start", help="Required field")
        with col_end:
            end_date = st.date_input("End Date *", value=date(2025, 11, 30), key="recon_end", help="Required field")
